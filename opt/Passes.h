...
struct LICM : public LoopPass
{
	...
	// Helper function to determine if an instruction is safe to hoist
	bool isSafeToHoistInstr(llvm::Instruction* instr);

	// Helper function to hoist an instruction
	void hoistInstr(llvm::Instruction* instr);
